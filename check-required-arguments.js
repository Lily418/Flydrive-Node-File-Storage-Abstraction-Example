const checkRequiredArguments = argv => {
    ...
    if (argv.disk === "spaces" && !requiredSpacesArguments.every(a => a)) {
        console.error(
            "When using spaces disk you must provide key, secret, endpoint and bucket command line arguments. See README for usage instructions."
        );
